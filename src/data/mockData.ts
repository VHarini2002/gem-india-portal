...
export const mockUsers: User[] = [
  { email: 'client@globalengine-india.com', password: 'Client@123', role: 'client', name: 'Rajesh Kumar', company: 'AeroLease Corp' },
  { email: 'lessor@globalengine-india.com', password: 'Client@123', role: 'client', name: 'Sarah Mitchell', company: 'Global Lessors Inc' },
  { email: 'teardown@globalengine-india.com', password: 'Client@123', role: 'client', name: 'David Chen', company: 'TechJet Aviation' },
  { email: 'kam@globalengine-india.com', password: 'KAM@123', role: 'kam', name: 'Priya Sharma' },
];
...
export const mockEngines: Engine[] = [
  { id: '1', esn: 'ESN-726481', workOrder: 'WO-2024-001', model: 'CFM56-5B', clientName: 'AeroLease Corp', clientEmail: 'client@globalengine-india.com', serviceType: 'Teardown, Repair & Sell', status: 'Disassembly', currentLocation: 'Chennai, India', modeOfTransport: 'Air', progress: 45, lastUpdated: '2024-12-15', inductionDate: '2024-09-01', expectedCompletion: '2025-03-15', currentPhase: 'Disassembly' },
  { id: '2', esn: 'ESN-839205', workOrder: 'WO-2024-002', model: 'V2500-A5', clientName: 'AeroLease Corp', clientEmail: 'client@globalengine-india.com', serviceType: 'Teardown & Return', status: 'In Transit', currentLocation: 'Singapore', modeOfTransport: 'Sea', progress: 25, lastUpdated: '2024-12-14', inductionDate: '2024-10-15', expectedCompletion: '2025-04-01', currentPhase: 'Transit' },
  { id: '3', esn: 'ESN-451923', workOrder: 'WO-2024-003', model: 'PW1100G', clientName: 'Global Lessors Inc', clientEmail: 'lessor@globalengine-india.com', serviceType: 'Lease Storage', status: 'In Storage', currentLocation: 'Chennai, India', modeOfTransport: 'Road', progress: 60, lastUpdated: '2024-12-13', inductionDate: '2024-06-01', expectedCompletion: '2025-06-01', currentPhase: 'Preservation Active' },
  { id: '4', esn: 'ESN-672314', workOrder: 'WO-2024-004', model: 'CFM56-7B', clientName: 'Global Lessors Inc', clientEmail: 'lessor@globalengine-india.com', serviceType: 'Teardown, Repair & Sell', status: 'Inspection', currentLocation: 'Chennai, India', modeOfTransport: 'Air', progress: 55, lastUpdated: '2024-12-12', inductionDate: '2024-08-15', expectedCompletion: '2025-02-28', currentPhase: 'Inspection' },
  { id: '5', esn: 'ESN-198734', workOrder: 'WO-2024-005', model: 'LEAP-1A', clientName: 'TechJet Aviation', clientEmail: 'teardown@globalengine-india.com', serviceType: 'Teardown & Return', status: 'In Repair', currentLocation: 'Dubai, UAE', modeOfTransport: 'Air', progress: 70, lastUpdated: '2024-12-11', inductionDate: '2024-07-01', expectedCompletion: '2025-01-30', currentPhase: 'Repair' },
  { id: '6', esn: 'ESN-564218', workOrder: 'WO-2024-006', model: 'CF34-10E', clientName: 'TechJet Aviation', clientEmail: 'teardown@globalengine-india.com', serviceType: 'Lease Storage', status: 'Preservation Active', currentLocation: 'Chennai, India', modeOfTransport: 'Road', progress: 40, lastUpdated: '2024-12-10', inductionDate: '2024-04-01', expectedCompletion: '2025-04-01', currentPhase: 'Stored' },
  { id: '7', esn: 'ESN-387456', workOrder: 'WO-2024-007', model: 'CFM56-5B', clientName: 'AeroLease Corp', clientEmail: 'client@globalengine-india.com', serviceType: 'Teardown, Repair & Sell', status: 'Completed', currentLocation: 'Chennai, India', modeOfTransport: 'Air', progress: 100, lastUpdated: '2024-12-09', inductionDate: '2024-03-01', expectedCompletion: '2024-11-30', currentPhase: 'Closed' },
  { id: '8', esn: 'ESN-921567', workOrder: 'WO-2024-008', model: 'V2500-A5', clientName: 'Global Lessors Inc', clientEmail: 'lessor@globalengine-india.com', serviceType: 'Lease Storage', status: 'In Storage', currentLocation: 'Singapore', modeOfTransport: 'Sea', progress: 50, lastUpdated: '2024-12-08', inductionDate: '2024-05-15', expectedCompletion: '2025-05-15', currentPhase: 'Stored' },
  { id: '9', esn: 'ESN-743892', workOrder: 'WO-2024-009', model: 'PW1100G', clientName: 'TechJet Aviation', clientEmail: 'teardown@globalengine-india.com', serviceType: 'Teardown, Repair & Sell', status: 'In Transit', currentLocation: 'London, UK', modeOfTransport: 'Air', progress: 15, lastUpdated: '2024-12-07', inductionDate: '2024-11-01', expectedCompletion: '2025-05-01', currentPhase: 'Transit' },
  { id: '10', esn: 'ESN-156723', workOrder: 'WO-2024-010', model: 'CFM56-7B', clientName: 'AeroLease Corp', clientEmail: 'client@globalengine-india.com', serviceType: 'Teardown & Return', status: 'Disassembly', currentLocation: 'Chennai, India', modeOfTransport: 'Road', progress: 35, lastUpdated: '2024-12-06', inductionDate: '2024-09-15', expectedCompletion: '2025-03-01', currentPhase: 'Disassembly' },
  { id: '11', esn: 'ESN-482916', workOrder: 'WO-2024-011', model: 'LEAP-1A', clientName: 'Global Lessors Inc', clientEmail: 'lessor@globalengine-india.com', serviceType: 'Teardown, Repair & Sell', status: 'In Repair', currentLocation: 'Frankfurt, Germany', modeOfTransport: 'Air', progress: 65, lastUpdated: '2024-12-05', inductionDate: '2024-07-15', expectedCompletion: '2025-02-15', currentPhase: 'Repair' },
  { id: '12', esn: 'ESN-635174', workOrder: 'WO-2024-012', model: 'CF34-10E', clientName: 'TechJet Aviation', clientEmail: 'teardown@globalengine-india.com', serviceType: 'Lease Storage', status: 'Ready for Release', currentLocation: 'Miami, USA', modeOfTransport: 'Sea', progress: 90, lastUpdated: '2024-12-04', inductionDate: '2024-02-01', expectedCompletion: '2025-01-15', currentPhase: 'Ready for Release' },
];
